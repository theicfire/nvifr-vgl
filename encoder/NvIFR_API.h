 ...
 * call the API entry points through this class, e.g.
 * 'nvIFR.nvIFROGLCreateSession(...)'.
 */
...
class NvIFRAPI {
 public:
  ...
  bool initialize() {
    ...
    nvIFROGLCreateTransferToSysObject =
        apiFunctionList.nvIFROGLCreateTransferToSysObject;
    nvIFROGLCreateTransferToHwEncObject =
        apiFunctionList.nvIFROGLCreateTransferToHwEncObject;
    nvIFROGLDestroyTransferObject =
        apiFunctionList.nvIFROGLDestroyTransferObject;
    nvIFROGLTransferFramebufferToSys =
        apiFunctionList.nvIFROGLTransferFramebufferToSys;
    nvIFROGLTransferFramebufferToHwEnc =
        apiFunctionList.nvIFROGLTransferFramebufferToHwEnc;
